<template>
  <div class="chat-wrapper">
    ...
    <button @click="toggleChat" class="toggle-button">
      <img :src="isChatOpen ? closeIcon : robotAvatar" alt="Toggle chat">
    </button>
    ...
    <div v-if="isChatOpen" class="chat-container">
      <div class="chat-header" style="height: auto;">
        ...
        <div class="header-content">
          <img :src="robotAvatar" class="avatar" alt="AI Assistant">
      ...
      <div class="chat-input">
        <div class="input-container d-flex align-center">
          <input v-model="userInput" @keyup.enter="sendMessage" placeholder="给AI助手发送消息" :disabled="isLoading"
            ref="inputRef" />
